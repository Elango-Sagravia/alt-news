  ...
  <body style="word-spacing:normal;background-color:#f0f1f3;">
    ...
    <!-- Logo Header -->
      ...
      ><p style="
          ...
          <p style="
              font-size: 16px;
              line-height: 1.4;
            ">Welcome to <strong><i>AltDaily News!</i></strong></p></div>
    ...
    <!-- Spotlight contents --><!-- Content sections -->
      ...
      ><p style="font-size: 16px; line-height: 1.4; ">
            To ensure every issue of AltDaily News reaches your inbox, simply reply with <strong>‘hello’</strong> or follow the steps below to whitelist our email address.
          </p></div>
